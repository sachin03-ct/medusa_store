    ...
    <div className="w-full bg-gradient-to-b from-slate-50 via-cyan-50/40 to-white min-h-screen">
      ...
      <div className="mt-6 px-4 lg:px-6">
        ...
        <h2 className="text-center text-lg md:text-2xl font-bold">
          Generic Medicine: India's Leading Online Pharmacy & Healthcare Platform
        </h2>
          ...
          {[
            {
              name: "Dr Morepen",
              image:
                "/hero/brands/img-1.png",
            },

            {
              name: "Dabur",
              image:
                "/hero/brands/img-2.png",
            },

            {
              name: "Himalaya",
              image:
                "/hero/brands/img-3.jpg",
            },

            {
              name: "Organic India",
              image:
                "/hero/brands/img-4.jpeg",
            },

            {
              name: "Wellman",
              image:
                "/hero/brands/img-5.png",
            },

            {
              name: "Tata 1mg",
              image:
                "/hero/brands/img-6.png",
            },

            {
              name: "Perfectil",
              image:
                "/hero/brands/img-7.webp",
            },

            {
              name: "PentaSure",
              image:
                "/hero/brands/img-8.png",
            },
          ].map((brand, index) => (
